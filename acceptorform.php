...
if (isset($_FILES['file']) && isset($_FILES['prescriptionfilename'])) {
    ...
    if (in_array($file_ext, $allowed)) {
        if ($file_error === 0) {
            ...
            $file_db_name = 'bloodreports/' . $file_name;
            $file_dest = 'bloodreports/' . $file_name_new;
    ...
    if (in_array($file_ext, $allowed)) {
        if ($file_error === 0) {
            ...
            $file_name_new = uniqid('', true) . '.' . $file_ext;
            $pres_db_name = 'bloodprescriptions/' . $file_name;
            $file_dest = 'bloodprescriptions/' . $file_name_new;
    ...
    <form action="acceptorform.php" method="post" enctype="multipart/form-data">
        ...
        <div class="contentform">
            ...
            <div class="rightcontact">
                ...
                <div class="form-group">
                    <p style="margin-top:8px; margin-bottom: 10px;">Upload Patient's Report
                        <span>*</span>
                    </p>
